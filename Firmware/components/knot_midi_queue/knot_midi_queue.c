...
static uint32_t DRAM_ATTR knot_midi_queueu_usbout_write_index = 0;
static uint32_t DRAM_ATTR knot_midi_queueu_usbout_read_index = 0;
static struct usb_midi_event_packet DRAM_ATTR knot_midi_queue_usbout[KNOT_MIDI_QUEUE_USBOUT_LENGTH] = {0};
...
static uint32_t DRAM_ATTR knot_midi_queueu_trsout_write_index = 0;
static uint32_t DRAM_ATTR knot_midi_queueu_trsout_read_index = 0;
static struct usb_midi_event_packet DRAM_ATTR knot_midi_queue_trsout[KNOT_MIDI_QUEUE_TRSOUT_LENGTH] = {0};

int IRAM_ATTR knot_midi_queue_trsout_push(struct usb_midi_event_packet ev) {
...
int IRAM_ATTR knot_midi_queue_trsout_available(void) {
...
int IRAM_ATTR knot_midi_queue_trsout_pop(struct usb_midi_event_packet* ev) {
